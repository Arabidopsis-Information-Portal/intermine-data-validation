...
@Component("uniprot_trembl_reader")
@PropertySources(value = { @PropertySource("classpath:/in/data_source.properties")
})
public class UniprotTremblXMLReader {

	private static final Logger log = LoggerFactory
			.getLogger(UniprotTremblXMLReader.class);
	...
	@Bean
	public ItemReader<UniprotEntry> uniprotTremblReader() {
		StaxEventItemReader<UniprotEntry> reader = new StaxEventItemReader<UniprotEntry>();
		reader.setResource(new FileSystemResource(environment.getProperty("uniprot_trembl.data.path")));
