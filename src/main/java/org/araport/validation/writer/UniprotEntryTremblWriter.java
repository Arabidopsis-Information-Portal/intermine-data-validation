...
@Component("uniprot_trembl_writer")
@Import({ DataSourceInfrastructureConfiguration.class })
public class UniprotEntryTremblWriter {
	...
	private static final String SQL_PATH = "/sql/staging/writer/uniprot_entry_trembl_prot_insert.sql";
	...
	@Bean
	public ItemWriter<UniprotEntry> uniprotTremblWriter() {

		log.info("Uniprot Trembl Prot Writer has started.");
